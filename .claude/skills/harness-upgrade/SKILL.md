...
4. **MIGRATIONS.md 해당 버전 섹션 삭제** — 업그레이드 완료 후 적용 완료된 버전 섹션(`## vX.Y ...` ~ 다음 `---` 이전)을 제거. MIGRATIONS.md는 항상 현재 적용 대상 버전 1개만 유지.
5. 완료 보고:
   ```

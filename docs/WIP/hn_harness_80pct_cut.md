...
**Acceptance Criteria**:
- [ ] Goal: 하네스 73% 삭감 — S2·S5·S6·S7·S8·S9 cascade 충족.
  ...
  검증:
    ...
    실측: 운용 검증
- [ ] §S-1·§S-2 완료 (e998278)
- [ ] §S-3·§S-4·§S-5·§S-6·§S-7 완료 (7d00a6d)
- [ ] §S-8·§S-9 완료 (본 commit)
- [ ] 다운스트림 1회 harness-upgrade 실행 — 격하 잔재(harness-dev) 자동 삭제 검증
- [ ] starter 본인 다음 wave 1건 실행 — 새 게이트(체크박스·S# 인용) 마찰 vs 학습 신호 균형 판정
- [ ] 누적 통계 박제 (rules/scripts/skills/agents 총량) — 본 wave §결과 표

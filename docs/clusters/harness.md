...
- [v0.18.3 린터 ENOENT 패턴 — 오탐·OS 커버리지 갭](../incidents/hn_lint_enoent_pattern_gaps.md) — tags: upstream-feedback, pre-commit-check, lint, enoent, false-positive, no-speculation

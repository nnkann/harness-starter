...
- `docs/WIP/decisions--hn_runtime_adapter_unification.md`: runtime adapter 통합 정책을 추가한다.
- `docs/WIP/guides--hn_hermes_integration.md`: Hermes를 orchestration adapter로 정리하고 runtime policy 문서를 참조한다.
